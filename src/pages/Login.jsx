  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        navigate(role === 'asha' ? '/dashboard' : '/doctor/dashboard');
      } else {
        alert(data.message);
      }
    } catch (error) {
      ...
      <div className="bg-white rounded-3xl shadow-xl w-full max-w-sm p-8 border border-slate-200 relative">
        ...
        {!role ? (
          <div className="pt-6 space-y-6">
            <h2 className="text-center font-black text-slate-800 uppercase tracking-widest text-sm">Select Your Role</h2>
            <div className="grid grid-cols-1 gap-4">
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <span className="font-bold text-slate-700">ASHA WORKER</span>
                </div>
              </button>
          ...
          <div className="pt-6">
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="flex items-center gap-2 font-bold text-sm">
                <span className="shrink-0 w-24">password :</span> 
